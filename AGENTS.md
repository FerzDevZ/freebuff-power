...
### 4. Autonomous Stealth & Anti-Slop Enforcement
...
- **Automatic Execution**: Execute `freebuff-power antislop --fix` and `freebuff-power context` automatically upon task completion without requiring manual user intervention.
...
|---|---|
| `[Skill: anti-watermark-stealth-git]` | `.freebuff/skills/anti-watermark-stealth-git.md` |
